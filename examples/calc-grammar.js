...
module.exports = function () {
    ...
    return new nearley.Parser([ {"name": "main","postprocess":  function(d) {return d[1]; } ,"symbols":[ "_", "AS", "_" ]}, {"name": "P","postprocess":  function(d) {return d[2]; } ,"symbols":[ {"literal":"("}, "_", "AS", "_", {"literal":")"} ]}, {"name": "P","postprocess":  id ,"symbols":[ "N" ]}, {"name": "E","postprocess":  function(d) {return Math.pow(d[0], d[4]); } ,"symbols":[ "P", "_", {"literal":"^"}, "_", "E" ]}, {"name": "E","postprocess":  id ,"symbols":[ "P" ]}, {"name": "MD","postprocess":  function(d) {return d[0]*d[4]; } ,"symbols":[ "MD", "_", {"literal":"*"}, "_", "E" ]}, {"name": "MD","postprocess":  function(d) {return d[0]/d[4]; } ,"symbols":[ "MD", "_", {"literal":"/"}, "_", "E" ]}, {"name": "MD","postprocess":  id ,"symbols":[ "E" ]}, {"name": "AS","postprocess":  function(d) {return d[0]+d[4]; } ,"symbols":[ "AS", "_", {"literal":"+"}, "_", "MD" ]}, {"name": "AS","postprocess":  function(d) {return d[0]-d[4]; } ,"symbols":[ "AS", "_", {"literal":"-"}, "_", "MD" ]}, {"name": "AS","postprocess":  id ,"symbols":[ "MD" ]}, {"name": "N","postprocess":  id ,"symbols":[ "float" ]}, {"name": "N$1","postprocess": function joiner(d) {
            return d.join('');
        },"symbols":[ {"literal":"s"}, {"literal":"i"}, {"literal":"n"} ]}, {"name": "N","postprocess":  function(d) {return Math.sin(d[2]); } ,"symbols":[ "N$1", "_", "P" ]}, {"name": "N$2","postprocess": function joiner(d) {
            return d.join('');
        },"symbols":[ {"literal":"c"}, {"literal":"o"}, {"literal":"s"} ]}, {"name": "N","postprocess":  function(d) {return Math.cos(d[2]); } ,"symbols":[ "N$2", "_", "P" ]}, {"name": "N$3","postprocess": function joiner(d) {
            return d.join('');
        },"symbols":[ {"literal":"t"}, {"literal":"a"}, {"literal":"n"} ]}, {"name": "N","postprocess":  function(d) {return Math.tan(d[2]); } ,"symbols":[ "N$3", "_", "P" ]}, {"name": "N$4","postprocess": function joiner(d) {
            return d.join('');
        },"symbols":[ {"literal":"a"}, {"literal":"s"}, {"literal":"i"}, {"literal":"n"} ]}, {"name": "N","postprocess":  function(d) {return Math.asin(d[2]); } ,"symbols":[ "N$4", "_", "P" ]}, {"name": "N$5","postprocess": function joiner(d) {
            return d.join('');
        },"symbols":[ {"literal":"a"}, {"literal":"c"}, {"literal":"o"}, {"literal":"s"} ]}, {"name": "N","postprocess":  function(d) {return Math.acos(d[2]); } ,"symbols":[ "N$5", "_", "P" ]}, {"name": "N$6","postprocess": function joiner(d) {
            return d.join('');
        },"symbols":[ {"literal":"a"}, {"literal":"t"}, {"literal":"a"}, {"literal":"n"} ]}, {"name": "N","postprocess":  function(d) {return Math.atan(d[2]); } ,"symbols":[ "N$6", "_", "P" ]}, {"name": "N$7","postprocess": function joiner(d) {
            return d.join('');
        },"symbols":[ {"literal":"p"}, {"literal":"i"} ]}, {"name": "N","postprocess":  function(d) {return Math.PI; } ,"symbols":[ "N$7" ]}, {"name": "N","postprocess":  function(d) {return Math.E; } ,"symbols":[ {"literal":"e"} ]}, {"name": "N$8","postprocess": function joiner(d) {
            return d.join('');
        },"symbols":[ {"literal":"s"}, {"literal":"q"}, {"literal":"r"}, {"literal":"t"} ]}, {"name": "N","postprocess":  function(d) {return Math.sqrt(d[2]); } ,"symbols":[ "N$8", "_", "P" ]}, {"name": "N$9","postprocess": function joiner(d) {
            return d.join('');
        },"symbols":[ {"literal":"l"}, {"literal":"n"} ]}, {"name": "N","postprocess":  function(d) {return Math.log(d[2]); }  ,"symbols":[ "N$9", "_", "P" ]}, {"name": "float","postprocess":  function(d) {return parseFloat(d[0] + d[1] + d[2])} ,"symbols":[ "int", {"literal":"."}, "int" ]}, {"name": "float","postprocess":  function(d) {return parseInt(d[0])} ,"symbols":[ "int" ]}, {"name": "int","postprocess":  id ,"symbols":[ /[0-9]/ ]}, {"name": "int","postprocess":  function(d) {return d[0] + d[1]} ,"symbols":[ "int", /[0-9]/ ]}, {"name": "_","postprocess":  function(d) {return null; } ,"symbols":[  ]}, {"name": "_","postprocess":  function(d) {return null; } ,"symbols":[ /[\s]/, "_" ]} ], "main");};
