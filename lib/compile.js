(function(root, factory) {
    ...
    function Compile(structure, opts, prevResult) {
        var unique = uniquer();
        ...
        var result = {
            rules: prevResult.rules || [],
            body: [], // @directives list
            customTokens: prevResult.customTokens || [], // %tokens
            config: prevResult.config || {}, // @config value
            macros: prevResult.macros || {},
            start: '',
            version: prevResult.version || 'unknown'
        };
