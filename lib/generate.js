...
generate.es2015 = generate.es6 = function (parser, exportName) {
    return "// Generated automatically by nearley\n" +
        ...
        "    ParserRules: " + serializeRules(parser.rules, generate.es2015.builtinPostprocessors) + ",\n" +
...
generate.es2015.builtinPostprocessors = {
    "joiner": "d => d.join('')",
    "arrconcat": "([el, arr]) => [el].concat(arr)",
    "arrpush": "([arr, el]) => arr.concat([el])",
    "nuller": "_ => null",
    "id": "id"
}
