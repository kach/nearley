...
var grammar = {
    ...
    {"name": "undefined$1", "symbols": [{"literal":":"}, {"literal":"+"}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "ebnf_modifier", "symbols": ["undefined$1"], "postprocess":  id },
    {"name": "undefined$2", "symbols": [{"literal":":"}, {"literal":"*"}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "ebnf_modifier", "symbols": ["undefined$2"], "postprocess":  id },
    {"name": "undefined$3", "symbols": [{"literal":":"}, {"literal":"?"}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "ebnf_modifier", "symbols": ["undefined$3"], "postprocess":  id },
