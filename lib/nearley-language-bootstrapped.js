...
var grammar = {
    ...
    {"name": "prod$ebnf$1$subexpression$1", "symbols": ["ws", "word", "ws", "string"]},
    {"name": "prod$ebnf$1", "symbols": ["prod$ebnf$1", "prod$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "prod", "symbols": [{"literal":"@"}, "word", "ws", "word", "prod$ebnf$1"], "postprocess": function(d) { return {config: d[1], value: [d[3], ...(d[4].map(e => [e[1], e[3]]))]}; }},
