...
var grammar = {
    ...
    {"name": "prod", "symbols": ["word", "_", "prod$ebnf$1", {"literal":">"}, "_", "expression+"], "postprocess": function(d) { return {name: d[0], rules: d[5]}; }},
    ...
    {"name": "prod", "symbols": ["word", {"literal":"["}, "wordlist", {"literal":"]"}, "_", "prod$ebnf$2", {"literal":">"}, "_", "expression+"], "postprocess": function(d) {return {macro: d[0], args: d[2], exprs: d[8]}}},
    ...
    {"name": "prod", "symbols": ["prod$string$1", "_", "string"], "postprocess": function(d) {return {include: d[2].literal, builtin: false}}},
    ...
    {"name": "prod", "symbols": ["prod$string$2", "_", "string"], "postprocess": function(d) {return {include: d[2].literal, builtin: true }}},
    ...
    {"name": "ws", "symbols": ["whitraw"]},
    {"name": "ws", "symbols": ["whitraw?", "comment", "_"]},
