...
var grammar = {
    ...
    {"name": "prod$ebnf$1$subexpression$2", "symbols": [{"literal":"="}]},
    {"name": "prod$ebnf$1", "symbols": ["prod$ebnf$1$subexpression$2", "prod$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    ...
    {"name": "prod$ebnf$2$subexpression$2", "symbols": [{"literal":"="}]},
    {"name": "prod$ebnf$2", "symbols": ["prod$ebnf$2$subexpression$2", "prod$ebnf$2"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
