...
module.exports = {
    rules: [
        ...
        rule(StringLiteral, [m("\""), Charset, m("\"")], function(d) {
        ...
        rule(Expression, [Expression, WS, StringLiteral], function(d){
            return d[0].concat([d[2]]);
        }),
        ...
        rule(ExpressionList, [ExpressionList, OptionalWS, m("|"), OptionalWS, CompleteExpression], function(d) {
            return d[0].concat([d[4]]);
        }),

        rule(ProductionRule, [Word, OptionalWS, m("-"), m(">"), OptionalWS, ExpressionList], function(d) {
