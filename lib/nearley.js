(function(root, factory) {
    ...
    StreamLexer.prototype.formatError = function(token, message) {
        ...
        if (typeof buffer === 'string') {
            ...
            var lastLineDigits = String(lines.length).length;
            message += " at line " + this.line + " col " + col + ":\n\n";
            message += lines
                .map(function(line, i) {
                    return pad(lineNo - lines.length + i + 1, lastLineDigits) + " " + line;
                })
                .join("\n");
    ...
    Parser.prototype.feed = function(chunk) {
        ...
        while (true) {
            try {
                ...
                err.token = e.token;
                throw err;
                // var err = new Error(lexer.formatError(e.token, "Syntax error"))
                // throw err;
            }
    ...
    Parser.prototype.reportErrorCommon = function(lexerMessage, tokenDisplay) {
        ...
        if (expectantStates.length === 0) {
            ...
            this.displayStates(lastColumn.states, lines);
        } else {
            ...
            stateStacks.forEach(function(stateStack) {
                ...
                this.displayStates(stateStack, lines);
            }, this);
        }
    ...
    Parser.prototype.displayStates = function(stateStack, lines) {
        var lastDisplay;
